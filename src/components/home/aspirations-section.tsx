  ...
  return (
    <section className="space-y-8">
      <SectionHeading
        ...
        description="How I make engineering trade-offs."
      />

      <SnapCarousel
        ariaLabel="career focus cards"
        itemClassName="w-[82%] shrink-0 snap-start sm:w-[47%] lg:w-[30%]"
        autoScroll
        autoScrollIntervalMs={4800}
      >
        {aspirations.map((aspiration) => (
          ...
          >
            ...
            <p className="text-clip-2 mt-2 text-sm leading-relaxed text-slate-300">{aspiration.text}</p>
          </article>
        ))}
      </SnapCarousel>
    </section>
